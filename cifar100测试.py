...
# ------------------------------
def main(args):
    FIXED_MODELS = ['Addepalli2022Efficient_RN18', 'Chen2024Data_WRN_34_10', 'Cui2023Decoupled_WRN-34-10', 'Debenedetti2022Light_XCiT-L12', 'Pang2022Robustness_WRN70_16']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', nargs='+', default=['cifar100'], help='Datasets')
